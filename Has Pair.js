// #Task Given a sorted array of integer numbers A and another integer number sum, write a function that returns true if there are two
//  (distinct) numbers in A that add up to sum. Return false otherwise.
